  ...
  return (
    <div className={cn('flex flex-col gap-[15px]', className)}>
      ...
      <div className="flex gap-[15px] items-center">
        <textarea
          className="p-[20px] rounded-[5px] bg-white/[0.07] text-[15px] h-[50px] outline-none focus:border-accent-green border-[1px] border-transparent text-blue-5 flex-1 min-h-[175px] resize-y"
          {...props}
        />
